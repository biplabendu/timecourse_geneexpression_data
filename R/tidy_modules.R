#' @title 
#' Make a table which maps genes to a cluster / module
#' 
#' @description 
#' a more detailed explanation of what the function does
#' 
#' @param merged_modules a character vector specifying which cluster a gene 
#' belongs to, usually indicated as colors.
#' 
#' @param mapping_tbl a table with two columns, `old_labels` and `new_labels`,
#' where the first column indicates the cluster name generated by WGCNA and the 
#' second column indicates the new names for the clusters.
#' 
#' @param data a dataframe where the rows represent different time points, 
#' columns represent genes, and values represent expression levels at 
#' corresponding time points
#' 
#' @return a table with 3 columns with the first being the gene_name, the second
#' is the module_identity, and the third are the old_labels for the module or 
#' cluster
#' 
#' @keyword internal
